...
//    private static boolean manualToggled = false;
    ...
    public static void set(double speed){
        ...
        if(manual == false){
            if(Robot.xboxEl.LStickY() == 1){ //Left stick/Bumper = Hatch
                if(Robot.xboxEl.LB() == true){ //High
                    ElCase = 2;
                }
            }
            if(Robot.xboxEl.LStickY() == -1){ 
                if(Robot.xboxEl.LB() == true){ //Mid
                    ElCase = 1;
                }
                else if(Robot.xboxEl.LB() == false){ //Low
                    ElCase = 0;
                }
            }
            if(Robot.xboxEl.RStickY() == 1){ //Right stick/bumper = Ball
                if(Robot.xboxEl.RB() == true){ //High
                    ElCase = 5;
                }
            }
            if(Robot.xboxEl.RStickY() == -1){ 
                if(Robot.xboxEl.RB() == false){ //Mid
                    ElCase = 4;
                }
                else if(Robot.xboxEl.RB() == false){ //Low
                    ElCase = 3;
                }
            }
